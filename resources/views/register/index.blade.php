                ...
                <div class="container">
                    <main class="form-register">
                        <form action="register" method="POST">
                            ...
                            <div class="form-floating">
                                <input type="text" name="email" class="form-control mt-2" id="email" placeholder="name@example.com">
                                <label fpr="email">Email Address</label>
                            </div>
                            <div class="form-floating">
                                <input type="text" name="password" class="form-control mt-2" id="password" placeholder="password">
